...
- Sprite pal 0 is VGA black (gun grain, court/rice doors, hub skeletons); unwritten skip is the hole; written 255 is VGA white (bone/ring); MINE skeletons use MINE.SET not the CST RGB cube
