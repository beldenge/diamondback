...
| 2026-08-29 | `dog1.mov` skip-rest on later remake passes did not fix the start hitch. Keep two full sequential still+audio passes (one growl each). Stutter remains. |
